...
static const _Coordinate_type_support_symbol_names_t _Coordinate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, coordinate_msg, msg, Coordinate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, coordinate_msg, msg, Coordinate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, coordinate_msg, msg, Coordinate)() {
  return &::coordinate_msg::msg::rosidl_typesupport_c::Coordinate_message_type_support_handle;
}
